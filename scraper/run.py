...
FULL_CATALOG_SITES = ['티처빌', '사제동행', '아이스크림', '교육사랑', 'T셀파', '카운피아', '에듀니티', '유니텔']  # 종료 자동정리 대상
...
# (카운피아도 신규 연동 — 기존 엑셀데이터 43건 중 48건이 실수집 결과(75건)와 일치해 바로 포함 — 2026-09-16)
# (에듀니티도 신규 연동 — name_strip_re로 "[상시연수]"/"-직무" 꼬리표 제거 후 44/55건 일치해 바로 포함 — 2026-09-16)
